...
var xtr:Dictionary
var url_PlayerData:String = "res://debug/save/PlayerData.bin"
var url_PlayerData2:String = "res://debug/save/PlayerData2.bin"
var url_PlayerData3:String = "res://debug/save/PlayerData3.bin"

var url_newPlayerData:String = "res://debug/save/PlayerData0.bin"

var inventory:Dictionary = {}
var inventory_maxSlots:int = 45
onready var playerData:Dictionary = Global_DataParser.load_data(url_PlayerData)
onready var newplayerData:Dictionary = Global_DataParser.load_data(url_newPlayerData)
...
func load_state():
	...
	if Globals.loadgstate == 0:
		url_PlayerData = "res://debug/save/PlayerData0.bin"
		playerData = Global_DataParser.load_data(url_PlayerData)
	elif Globals.loadgstate == 1:
		url_PlayerData = "res://debug/save/PlayerData.bin"
		playerData = Global_DataParser.load_data(url_PlayerData)
	elif Globals.loadgstate == 2:
		url_PlayerData = "res://debug/save/PlayerData2.bin"
		playerData = Global_DataParser.load_data(url_PlayerData)
	elif Globals.loadgstate == 3:
		url_PlayerData = "res://debug/save/PlayerData3.bin"
		playerData = Global_DataParser.load_data(url_PlayerData)
...
func load_newdata():
	if (xtr.empty()):
		...
		for slot in range (0, inventory_maxSlots):
			dict["inventory"][str(slot)] = {"id": "0", "amount": 0}
		Global_DataParser.write_data(url_newPlayerData, dict)
		inventory = dict["inventory"]
	else:
...
func save_data2() -> void:
	Global_DataParser.write_data(url_PlayerData2, {"inventory": inventory})
func save_data3() -> void:
	Global_DataParser.write_data(url_PlayerData3, {"inventory": inventory})
...
func inventory_combineItem(slot) -> int:
	var newAmount = inventory[String(slot)]["amount"] - 10
	if (newAmount < 1):
		inventory_updateItem(slot, 0, 0)
		return 0
	inventory[String(slot)]["amount"] = newAmount
